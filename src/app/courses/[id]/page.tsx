            ...
            {chapters.length > 0 && (
              <div className="flex items-center gap-3 overflow-x-auto pb-2">
                ...
                <button
                  ...
                  className={`px-5 py-2 rounded-full text-base font-medium transition whitespace-nowrap ${selectedChapter === 'all'
                ...
                {chapters.map((chapter) => {
                  ...
                  return (
                    <button
                      ...
                      className={`px-5 py-2 rounded-full text-base font-medium transition whitespace-nowrap ${selectedChapter === chapter.id
                        ? 'bg-blue-600 text-white'
                        : 'bg-white text-gray-700 hover:bg-gray-100'
                        }`}
                    >
