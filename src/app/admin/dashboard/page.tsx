...
export default function AdminDashboardPage() {
  ...
  const loadDashboardData = async () => {
    try {
      ...
      const [coursesData, vocabulariesData, reportsData, labelTagsData] = await Promise.all([
        coursesApi.getAll(),
      ...
      setStats({
        ...
        totalLabelTags: labelTagsData.length,
      });
      ...
      <div className="space-y-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-6">
          ...
          <Card className="bg-gradient-to-br from-blue-500 to-blue-600 text-white">
            ...
            <Link href={ROUTES.ADMIN_COURSES || "/admin/courses"} className="mt-4 inline-block text-blue-100 hover:text-white text-sm">
              ดูทั้งหมด →
            </Link>
          </Card>
          ...
          <Card className="bg-gradient-to-br from-purple-500 to-purple-600 text-white">
            ...
            <Link href={ROUTES.ADMIN_VOCABULARY || "/admin/vocabulary"} className="mt-4 inline-block text-purple-100 hover:text-white text-sm">
              ดูทั้งหมด →
            </Link>
          </Card>
          ...
          <Card className="bg-gradient-to-br from-indigo-500 to-indigo-600 text-white">
            ...
            <Link href="/admin/label" className="mt-4 inline-block text-indigo-100 hover:text-white text-sm">
              จัดการ →
            </Link>
          </Card>
          ...
          <Card className="bg-gradient-to-br from-orange-500 to-orange-600 text-white">
            ...
            <Link href="/admin/reports" className="mt-4 inline-block text-orange-100 hover:text-white text-sm">
              ตรวจสอบ →
            </Link>
          </Card>
          ...
          <Card className="bg-gradient-to-br from-pink-500 to-pink-600 text-white">
            ...
            <Link href="/admin/reports" className="mt-4 inline-block text-pink-100 hover:text-white text-sm">
              ดูทั้งหมด →
            </Link>
          </Card>
        </div>
